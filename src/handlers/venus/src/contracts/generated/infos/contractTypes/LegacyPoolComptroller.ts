...
export declare namespace ComptrollerV13Storage {
  export type FacetAddressAndPositionStruct = {
    facetAddress: string;
    functionSelectorPosition: BigNumberish;
  };

  export type FacetAddressAndPositionStructOutput = [string, BigNumber] & {
    facetAddress: string;
    functionSelectorPosition: BigNumber;
  };
}
...
export interface LegacyPoolComptrollerInterface extends utils.Interface {
  functions: {
    ...
    '_setForcedLiquidation(address,bool)': FunctionFragment;
    '_setForcedLiquidationForUser(address,address,bool)': FunctionFragment;
    ...
    '_setPrimeToken(address)': FunctionFragment;
    ...
    'diamondCut((address,uint8,bytes4[])[])': FunctionFragment;
    'enterMarkets(address[])': FunctionFragment;
    'exitMarket(address)': FunctionFragment;
    'facetAddress(bytes4)': FunctionFragment;
    'facetAddresses()': FunctionFragment;
    'facetFunctionSelectors(address)': FunctionFragment;
    'facetPosition(address)': FunctionFragment;
    ...
    'isForcedLiquidationEnabledForUser(address,address)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: '_setPrimeToken', values: [string]): string;
  ...
  encodeFunctionData(functionFragment: 'facetPosition', values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: '_setForcedLiquidation', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_setForcedLiquidationForUser', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: '_setPrimeToken', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'facetPosition', data: BytesLike): Result;
  ...
  events: {
    ...
    'DiamondCut((address,uint8,bytes4[])[])': EventFragment;
    ...
    'IsForcedLiquidationEnabledForUserUpdated(address,address,bool)': EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: 'IsForcedLiquidationEnabledForUserUpdated'): EventFragment;
  getEvent(nameOrSignatureOrTopic: 'IsForcedLiquidationEnabledUpdated'): EventFragment;
...
export interface IsForcedLiquidationEnabledForUserUpdatedEventObject {
  borrower: string;
  vToken: string;
  enable: boolean;
}
export type IsForcedLiquidationEnabledForUserUpdatedEvent = TypedEvent<
  [string, string, boolean],
  IsForcedLiquidationEnabledForUserUpdatedEventObject
>;

export type IsForcedLiquidationEnabledForUserUpdatedEventFilter =
  TypedEventFilter<IsForcedLiquidationEnabledForUserUpdatedEvent>;
...
export type NewPrimeTokenEvent = TypedEvent<[string, string], NewPrimeTokenEventObject>;
...
export interface LegacyPoolComptroller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LegacyPoolComptrollerInterface;
  ...
  functions: {
    ...
    facetPosition(facet: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    facets(overrides?: CallOverrides): Promise<[Diamond.FacetStructOutput[]]>;
    ...
    isForcedLiquidationEnabled(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    _setPrimeToken(_prime: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    diamondCut(diamondCut_: IDiamondCut.FacetCutStruct[], overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    DiamondCut(_diamondCut?: null): DiamondCutEventFilter;
    ...
    'MarketListed(address)'(vToken?: string | null): MarketListedEventFilter;
    MarketListed(vToken?: string | null): MarketListedEventFilter;
  ...
  estimateGas: {
    ...
    isForcedLiquidationEnabled(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    facetPosition(facet: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
