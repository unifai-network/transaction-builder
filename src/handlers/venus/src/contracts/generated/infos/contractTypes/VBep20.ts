...
export interface NewReduceReservesBlockDeltaEventObject {
  ...
  newReduceReservesBlockDelta: BigNumber;
}
export type NewReduceReservesBlockDeltaEvent = TypedEvent<
  [BigNumber, BigNumber],
  NewReduceReservesBlockDeltaEventObject
>;

export type NewReduceReservesBlockDeltaEventFilter =
  TypedEventFilter<NewReduceReservesBlockDeltaEvent>;
...
export interface SpreadReservesReducedEventObject {
  protocolShareReserve: string;
  reduceAmount: BigNumber;
  newTotalReserves: BigNumber;
}
export type SpreadReservesReducedEvent = TypedEvent<
  [string, BigNumber, BigNumber],
...
export interface VBep20 extends BaseContract {
  ...
  functions: {
    ...
    setReduceReservesBlockDelta(
      _newReduceReservesBlockDelta: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
